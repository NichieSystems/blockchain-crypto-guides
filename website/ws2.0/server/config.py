...
class Config:
    SECRET_KEY = os.environ.get('SECRET_KEY') or '07089997878493961'
    ...
    SCURDEX_MAIL_SENDER = 'Scurdex Admin <scurdex@protonmail.com>' 
...
class ProductionConfig(Config):
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL') or 'sqlite:///' + os.path.join(basedir, 'scurdexdb.sqlite')
