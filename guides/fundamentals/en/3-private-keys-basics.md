...
For instance, when creating the wallet on [Scurdex wallet](https://scurdex.com) the user gets a single private key for all cryptocurrencies supported by a wallet.
