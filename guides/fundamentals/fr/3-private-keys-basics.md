...
Par exemple, lors de la création du portefeuille avec [Scurdex wallet](https://scurdex.com) l'utilisateur obtient une seule clé privée pour 5 crypto-monnaies:
